...
} from '@/modules/portfolio-management/dto/asset-allocation/update-asset-allocation.dto';
...
export class AdminAssetAllocationController {
  ...
  async getAllocationsByRiskProfile(
    @Param('riskProfileId') riskProfileId: string,
  ) {
    return this.assetAllocationService.getAllocationsByRiskProfile(
      riskProfileId,
    );
  }
