...
export class DebtManagementController {
  ...
  async updateDebt(
    ...
    return await this.debtManagementService.updateDebt(user.sub, debtId, updateDebtDto);
  }
  ...
  async updateDebtBalance(
    ...
    return await this.debtManagementService.updateDebtBalance(user.sub, debtId, updateBalanceDto);
  }
  ...
  async getTotalDebtValue(
    ...
    const totalValue = await this.debtManagementService.getTotalDebtValue(user.sub);
    return { totalValue };
  }
  ...
  async createDebtCategory(
    ...
    return await this.debtManagementService.createDebtCategory(createDebtCategoryDto);
  }
