...
export class AssetManagementController {
  ...
  async createAsset(
    ...
    return await this.assetManagementService.createAsset(user.sub, createAssetDto);
  }
  ...
  async updateAsset(
    ...
    return await this.assetManagementService.updateAsset(user.sub, assetId, updateAssetDto);
  }
  ...
  async updateAssetValue(
    ...
    return await this.assetManagementService.updateAssetValue(user.sub, assetId, updateValueDto);
  }
  ...
  async getTotalAssetValue(
    ...
    const totalValue = await this.assetManagementService.getTotalAssetValue(user.sub);
    return { totalValue };
  }
  ...
  async getRecentlyUpdatedAssets(
    ...
    return await this.assetManagementService.getRecentlyUpdatedAssets(user.sub, days);
  }
  ...
  async createAssetCategory(
    ...
    return await this.assetManagementService.createAssetCategory(createAssetCategoryDto);
  }
} 